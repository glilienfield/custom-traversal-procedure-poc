...
class CustomFunctionsTest {
    ...
    void test_both_nodes_have_null_lists() {
        try (Session session = driver.session()) {
            session.run("create (a{id: 1}), (b{id: 2})");
            ...
            if (result.hasNext()) {
                ...
                boolean isSimilar = record.get("result").asBoolean();
    ...
    void test_a_node_has_null_lists_b_node_has_non_null_list() {
        try (Session session = driver.session()) {
            session.run("create (a{id: 1}), (b{id: 2, list_extern: ['1','2']})");
            Result result = session.run("match (a{id: 1}), (b{id: 2}) return com.glilienfield.isSimilar('list_intern', a, 'list_extern', b) as result");
            if (result.hasNext()) {
                Record record = result.next();
                boolean isSimilar = record.get("result").asBoolean();
    ...
    void test_a_node_has_non_null_lists_b_node_has_null_list() {
        try (Session session = driver.session()) {
            session.run("create (a{id: 1, list_intern: ['1','2']}), (b{id: 2})");
            Result result = session.run("match (a{id: 1}), (b{id: 2}) return com.glilienfield.isSimilar('list_intern', a, 'list_extern', b) as result");
            if (result.hasNext()) {
                Record record = result.next();
                boolean isSimilar = record.get("result").asBoolean();
    ...
    void test_a_and_b_have_lists_with_no_common_elements() {
        try (Session session = driver.session()) {
            session.run("create (a{id: 1, list_intern: ['10','20']}), (b{id: 2, list_extern: ['1','2']})");
            Result result = session.run("match (a{id: 1}), (b{id: 2}) return com.glilienfield.isSimilar('list_intern', a, 'list_extern', b) as result");
            if (result.hasNext()) {
                Record record = result.next();
                boolean isSimilar = record.get("result").asBoolean();
    ...
    void test_a_and_b_have_lists_with_one_common_element() {
        try (Session session = driver.session()) {
            session.run("create (a{id: 1, list_intern: ['10','2']}), (b{id: 2, list_extern: ['1','2']})");
            Result result = session.run("match (a{id: 1}), (b{id: 2}) return com.glilienfield.isSimilar('list_intern', a, 'list_extern', b) as result");
            if (result.hasNext()) {
                Record record = result.next();
                boolean isSimilar = record.get("result").asBoolean();
    ...
    void test_a_and_b_have_lists_with_multiple_common_element() {
        try (Session session = driver.session()) {
            session.run("create (a{id: 1, list_intern: ['10','2', '100']}), (b{id: 2, list_extern: ['100', '1','2']})");
            Result result = session.run("match (a{id: 1}), (b{id: 2}) return com.glilienfield.isSimilar('list_intern', a, 'list_extern', b) as result");
            if (result.hasNext()) {
                Record record = result.next();
                boolean isSimilar = record.get("result").asBoolean();
    ...
    void test_a_has_a_single_element_and_b_has_a_list_that_contains_the_element_of_a() {
        try (Session session = driver.session()) {
            session.run("create (a{id: 1, list_intern: '2'}), (b{id: 2, list_extern: ['100', '1','2']})");
            Result result = session.run("match (a{id: 1}), (b{id: 2}) return com.glilienfield.isSimilar('list_intern', a, 'list_extern', b) as result");
            if (result.hasNext()) {
                Record record = result.next();
                boolean isSimilar = record.get("result").asBoolean();
    ...
    void test_b_has_a_single_element_and_a_has_a_list_that_contains_the_element_of_b() {
        try (Session session = driver.session()) {
            session.run("create (a{id: 1, list_intern: ['100', '1','2']}), (b{id: 2, list_extern: '2'})");
            Result result = session.run("match (a{id: 1}), (b{id: 2}) return com.glilienfield.isSimilar('list_intern', a, 'list_extern', b) as result");
            if (result.hasNext()) {
                Record record = result.next();
                boolean isSimilar = record.get("result").asBoolean();
    ...
    void test_a_has_a_single_element_and_b_has_the_single_element_of_b() {
        try (Session session = driver.session()) {
            session.run("create (a{id: 1, list_intern: '2'}), (b{id: 2, list_extern: '2'})");
            Result result = session.run("match (a{id: 1}), (b{id: 2}) return com.glilienfield.isSimilar('list_intern', a, 'list_extern', b) as result");
            if (result.hasNext()) {
                Record record = result.next();
                boolean isSimilar = record.get("result").asBoolean();
    ...
    void test_a_and_b_have_a_single_element_that_are_not_equal() {
        try (Session session = driver.session()) {
            session.run("create (a{id: 1, list_intern: '2'}), (b{id: 2, list_extern: '4'})");
            Result result = session.run("match (a{id: 1}), (b{id: 2}) return com.glilienfield.isSimilar('list_intern', a, 'list_extern', b) as result");
            if (result.hasNext()) {
                Record record = result.next();
                boolean isSimilar = record.get("result").asBoolean();
